...
""" Evaluator of VGG transfered model (based on 7 or 3 classes)
    Outputs loss and accuracy on specified test set
    Usage: python3 evaluate_vgg16.py --data_dir <DATASET_DIR> --label_scheme <0 for 7 classes or 1 for 3 classes>
"""
